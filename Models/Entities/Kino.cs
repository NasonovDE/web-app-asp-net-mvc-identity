...
using web_app_asp_net_mvc_identity.Extensions;
using web_app_asp_net_mvc_identity.Models.Attributes;
...
namespace web_app_asp_net_mvc_identity.Models
{
    public class Kino
    {
        ...
        [Display(Name = "Дата сеанса", Order = 10)]
        ...
        // [XmlElement(DataType = "NextArrivalDate")]
        ...
        [Display(Name = "Время сеанса", Order = 10)]
        public string StringKinoTime { get; set; }
